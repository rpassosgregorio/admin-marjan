				...
				<div class="box-body">
					...
					<?php echo form_open_multipart();?>
						...
						<div class="row">
							<div class="col-md-5">
								<div class="form-group">
									...
									<input type="text" class="form-control" id="name" name="name" placeholder="Nome" value="<?php echo $object->name; ?>" required>
								</div>
							</div>
							...
							<div class="col-md-5">
								<div class="form-group">
				                    ...
				                    <input type="email" class="form-control" id="email" name="email" placeholder="E-email" value="<?php echo $object->email; ?>" required>
				                 </div>
			               	 </div>
		               	</div>
						...
						<div class="row">
							...
							<div class="col-md-5">
								<div class="form-group">
									...
									<input type="password" class="form-control" name="conf_password" id="conf_password" placeholder="Confirme a senha" data-parsley-equalto="#senha" >
								</div>
							</div>
						</div>
						...
						<table cellpadding="0" cellspacing="0" border="0" width="400" class="table-admin">
							...
							foreach($this->menu as $object_menu){

								if(count($object_menu['submodules']) == count($access_modules)){
									$check_admin = "checked";
								}
							...
							<thead>
								<tr>
									<th class="colInput" width="50"><input type="checkbox" <?php echo $check_admin?> name="todosCheckbox" title="Selecionar todos" class="check-all" /></th>
							...
							<?php foreach($this->menu as $object_menu){ ?>
								...
								<tbody>
									...
									<?php foreach($object_menu['submodules'] as $object_submodule){
										      ...
										      foreach($access_modules as $object_allowed_submodule){

											      if($object_allowed_submodule->id_submodule == $object_submodule->id){
									...
									?>
										...
										<tr class="itemAcesso">
											<td class="colInput"><input type="checkbox" name="id_submodule[]" <?php echo $checked; ?> id="check<?php echo $object_submodule->id; ?>" value="<?php echo $object_submodule->id; ?>" /></td>

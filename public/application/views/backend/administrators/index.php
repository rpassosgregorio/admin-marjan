					...
					<table class='table table-bordered table-striped dataTable no-drag' data-order-field='<?php echo $order_field['field']; ?>' data-order-sort='<?php echo $order_field['order']; ?>'>
						...
						<thead>
							<tr>
								...
								<th data-field='name' data-order-asc='<?php echo base_url($this->base_cms).'/'.$this->controller_module?>/order_field_grid/<?php echo $page_cur.'/name/asc'.$search_field_format; ?>' data-order-desc='<?php echo base_url($this->base_cms).'/'.$this->controller_module?>/order_field_grid/<?php echo $page_cur.'/name/desc'.$search_field_format; ?>'>Nome</th>
								<th data-field='email' data-order-asc='<?php echo base_url($this->base_cms).'/'.$this->controller_module?>/order_field_grid/<?php echo $page_cur.'/email/asc'.$search_field_format; ?>' data-order-desc='<?php echo base_url($this->base_cms).'/'.$this->controller_module?>/order_field_grid/<?php echo $page_cur.'/email/desc'.$search_field_format; ?>'>Email</th>
								<th data-field='date_last_login' data-order-asc='<?php echo base_url($this->base_cms).'/'.$this->controller_module?>/order_field_grid/<?php echo $page_cur.'/date_last_login/asc'.$search_field_format; ?>' data-order-desc='<?php echo base_url($this->base_cms).'/'.$this->controller_module?>/order_field_grid/<?php echo $page_cur.'/date_last_login/desc'.$search_field_format; ?>'>Último login</th>

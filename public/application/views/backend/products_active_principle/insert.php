		               	...
		               	<div class="row">
							<div class="col-md-5">
								<div class="form-group">
									...
									<input type="text" class="form-control" id="milligram_value" name="milligram_value" placeholder="" value="<?php echo set_value('milligram_value'); ?>" required>
								</div>
							</div>
		               	...
		               	<div class="row">
							<div class="col-md-5">
								<div class="form-group">
									...
									<input type="text" class="form-control" id="unit" name="unit" placeholder="" value="<?php echo set_value('unit'); ?>" required>
								</div>
							</div>

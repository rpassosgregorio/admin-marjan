					...
					<table class='table table-bordered table-striped dataTable no-drag' data-order-field='<?php echo $order_field['field']; ?>' data-order-sort='<?php echo $order_field['order']; ?>'>
						...
						<thead>
							<tr>
								...
								<th data-field='milligram_value' data-order-asc='<?php echo base_url($this->base_cms).'/'.$this->controller_module?>/order_field_grid/<?php echo $page_cur.'/milligram_value/asc'.$search_field_format; ?>' data-order-desc='<?php echo base_url($this->base_cms).'/'.$this->controller_module?>/order_field_grid/<?php echo $page_cur.'/milligram_value/desc'.$search_field_format; ?>'>Valor da miligrama</th>
								<th data-field='unit' data-order-asc='<?php echo base_url($this->base_cms).'/'.$this->controller_module?>/order_field_grid/<?php echo $page_cur.'/unit/asc'.$search_field_format; ?>' data-order-desc='<?php echo base_url($this->base_cms).'/'.$this->controller_module?>/order_field_grid/<?php echo $page_cur.'/unit/desc'.$search_field_format; ?>'>Unidade</th>
							...
							<?php if(!empty($list_objects)){?>
								...
								<?php foreach($list_objects as $object){ ?>
									...
									<tr data-status='<?php echo $object->active?>' data-id='<?php echo $object->id; ?>'>
										...
										<td><a href='<?php echo base_url($this->base_cms).'/'.$this->controller_module.'/edit/'.$page_cur.'/'.$object->id.$search_field_format; ?>'> <?php echo $object->milligram_value; ?> </a></td>
										<td><a href='<?php echo base_url($this->base_cms).'/'.$this->controller_module.'/edit/'.$page_cur.'/'.$object->id.$search_field_format; ?>'> <?php echo $object->unit; ?> </a></td>

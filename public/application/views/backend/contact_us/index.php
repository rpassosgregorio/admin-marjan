								...
								<form action="<?php echo base_url($this->base_cms.'/'.$this->controller_module.'/save'); ?>" method="post" role="form" class="admingrid-modal-form" enctype="multipart/form-data" data-parsley-validate>
									...
									<div class="row">
										...
										<div class="col-xs-6">
											<div class="form-group">
												...
												<textarea class="form-control" name="section1_title" placeholder="Texto esquerda"><?php echo isset($object->id) ? MY_Controller_CMS::nl2br_str_decode($object->section1_title) : ''; ?></textarea>
											</div>
										</div>
									...
									<div class="row">
										...
										<div class="col-xs-12">
											<div class="form-group">
												<label>Texto</label>
												<textarea class="form-control" name="section1_text" placeholder="Texto esquerda"><?php echo isset($object->id) ? MY_Controller_CMS::nl2br_str_decode($object->section1_text) : ''; ?></textarea>
											</div>
										</div>
									...
									<div class="row">
										...
										<div class="col-xs-6">
											<div class="form-group">
												...
												<input type="text" class="form-control" name="section4_social_media3_text_link" value="<?php echo isset($object->id) ? MY_Controller_CMS::nl2br_str_decode($object->section4_social_media3_text_link) : ''; ?>">
											</div>
										</div>
										...
										<div class="col-xs-6">
											<div class="form-group">
												...
												<input type="text" class="form-control" name="section4_social_media3_link" value="<?php echo isset($object->id) ? MY_Controller_CMS::nl2br_str_decode($object->section4_social_media3_link) : ''; ?>">
											</div>
										</div>

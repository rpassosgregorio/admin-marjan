				...
				<div class='box-body'>
					...
					<section class="admingrid">
						...
						<article class="admingrid-item admingrid-item--3">
							<a href="#" class="admingrid-item-social-btn" data-open-modal="#social-facebook">
								<img src="<?php echo base_url(); ?>application/views/backend/assets/dist/img/icon-facebook.png" alt="">
							</a>

							<a href="#" class="admingrid-item-social-btn" data-open-modal="#social-twitter">
								<img src="<?php echo base_url(); ?>application/views/backend/assets/dist/img/icon-twitter.png" alt="">
							</a>
						</article>
						...
						<div class="admingrid-modal" data-modal="social-facebook">
									...
									<div class="row">
										<div class="col-xs-6">
											<div class="form-group">
												...
												<input type="text" class="form-control" name="link_facebook" placeholder="" value="<?php echo isset($object->id) ? MY_Controller_CMS::nl2br_str_decode($object->link_facebook) : ''; ?>">
											</div>
										</div>
									</div>
						...
						<div class="admingrid-modal" data-modal="social-twitter">
									...
									<div class="row">
										<div class="col-xs-6">
											<div class="form-group">
												...
												<input type="text" class="form-control" name="link_twitter" placeholder="" value="<?php echo isset($object->id) ? MY_Controller_CMS::nl2br_str_decode($object->link_twitter) : ''; ?>">
											</div>
										</div>
									</div>

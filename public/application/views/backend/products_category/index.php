					...
					<table class='table table-bordered table-striped dataTable no-drag' data-order-field='<?php echo $order_field['field']; ?>' data-order-sort='<?php echo $order_field['order']; ?>'>
						...
						<thead>
							<tr>
								...
								<th data-field='is_food' data-order-asc='<?php echo base_url($this->base_cms).'/'.$this->controller_module?>/order_field_grid/<?php echo $page_cur.'/is_food/asc'.$search_field_format; ?>' data-order-desc='<?php echo base_url($this->base_cms).'/'.$this->controller_module?>/order_field_grid/<?php echo $page_cur.'/is_food/desc'.$search_field_format; ?>'>É Alimento?</th>
							...
							<?php if(!empty($list_objects)){?>
								...
								<?php foreach($list_objects as $object){ ?>
									...
									<tr data-status='<?php echo $object->active?>' data-id='<?php echo $object->id; ?>'>
										...
										<td><a href='<?php echo base_url($this->base_cms).'/'.$this->controller_module.'/edit/'.$page_cur.'/'.$object->id.$search_field_format; ?>'> <?php echo $object->is_food ? 'Sim' : 'Não'; ?> </a></td>

...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    watch: {
      ...
      files: ["build/less/*.less", "build/less/skins/*.less", "dist/js/app.js", "dist/js/extras.js"],
      tasks: ["less", "uglify"]
    },
    ...
    less: {
      ...
      development: {
        ...
        files: {
          ...
          "dist/css/extras.css": "build/less/extras.less",
    ...
    uglify: {
      ...
      my_target: {
        files: {
          ...
          'dist/js/extras.min.js': ['dist/js/extras.js']
        }
      }
    },

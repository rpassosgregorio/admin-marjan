<main class="main-health-doctors">
	...
	<section class="first-section-health-doctors">
		<div class="first-section-wrapper" id="first_section_wrapper" style="background-image: url(<?php echo MY_Controller_CMS::get_path_file('our_history', $object->principal_image); ?>); background-position: center;">
		...
		<div class="call-to-next" id="call_to_next">
			<img src="<?php echo MY_Controller_CMS::get_path_file('our_history', $object->calltonext_section_image); ?>" />
		</div>
	</section>
